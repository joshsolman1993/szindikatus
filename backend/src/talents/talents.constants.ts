...
export interface TalentDefinition {
    ...
    bonus: {
        type: 'money_multiplier' | 'defense_multiplier' | 'max_energy' | 'damage_multiplier' | 'property_income_multiplier';
        value: number;
    };
}
...
export const TALENTS: Record<TalentId, TalentDefinition> = {
    ...
    [TalentId.SHARPSHOOTER]: {
        ...
        tier: 2,
        requiredLevel: 5,
        bonus: { type: 'damage_multiplier', value: 0.10 },
    },
    [TalentId.BANKER]: {
        id: TalentId.BANKER,
        name: 'Bankár',
        ...
        tier: 2,
        requiredLevel: 5,
        bonus: { type: 'property_income_multiplier', value: 0.10 },
    },
};
